...
type ConfirmAdminMode = "admin" | "deactivate";
    ...
    return (
      <Dialog open={open} onClose={onClose} size="md">
        <div className="flex items-center gap-3 mb-2">
          ...
          <DialogTitle className="text-gray-800">Deactivate Account</DialogTitle>
        </div>

        <DialogDescription className="text-sm text-gray-600 mt-2 space-y-2">
          <p>
            Deactivate <strong>{accountName}</strong> ({accountEmail})? They won&apos;t be able to sign in until
            reactivated.
          </p>
        </DialogDescription>
